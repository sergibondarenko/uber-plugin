...
export class Main extends React.Component {
  ...
  componentDidMount() {
    ...
    */
    ...
    httpClient.get('../api/bplugin/example').then(resp => {
          ...
          <EuiPageContent>
            <EuiPageContentHeader>
              <EuiTitle>
                <h2>
                  <FormattedMessage
                    id="bplugin.congratulationsTitle"
